...
//     Hello World! yazısının çıktığını doğrulayalım
    ...
    //   wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@id='loading']")));
      ...
      //start butonuna bastiktan sonra Hello World! yazisini gorunune kadar bekledir
...
//      Start button'nuna basalım
       ...
       //     Loading yazısının çıktığını doğrulayalım
       WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(20));
      wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[text()='loading']")));
       //start butonuna bastiktan sonra Loading webelementi  kaybolana kadar bekledir
