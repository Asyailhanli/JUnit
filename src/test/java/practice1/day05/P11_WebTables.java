...
public class P11_WebTables extends TestBase {
    @Test
    public void test(){
...
//        String otelClock=driver.findElement(By.xpath("//*[@class='tsc_table_s13']//tbody//tr[2]")).getText();
//        System.out.println(otelClock);
        //Lambda
//        System.out.println(driver.findElements(By.xpath("//*[@border='1']//tbody/tr")).
//                stream().filter(t -> t.getText().contains("601m")).findFirst().get().getText());
        int row=1;
...
//driver.findElements(By.xpath("//*[@border='1']//tbody//tr//td[3]")).
// forEach(t-> sum.addAndGet(Integer.parseInt(t.getText().replaceAll("m", ""))));
