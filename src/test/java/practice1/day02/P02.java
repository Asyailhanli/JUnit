...
//        driver.findElement(By.xpath("//*[@id='text']")).sendKeys("Asya", Keys.TAB,"ilhanli",Keys.TAB,"Davutoglu",
//                Keys.SPACE,Keys.TAB,"Mehmet");
        List<WebElement> list=driver.findElements(By.xpath("//input[@class='mdl-textfield__input']"));
        List<String> veriler=new ArrayList<>(Arrays.asList("asya","ilhanli","davutoglu","mehmet","davutoglu","diyarbakir",
                "silvan","lice","istanbul","bodrum","beylikduzu"));
