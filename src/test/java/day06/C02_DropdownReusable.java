...
public class C02_DropdownReusable {
 ...
 //REUSABLE METHOD:Dropdown icin tekrar tekrar kullanabilecegimiz bir method olusturalim
   ...
   //     selectFromDropdown(driver.findElement(By.xpath("//select[@id='year']")),"2005");-->year dan 2005 sececek
   ...
   //        Gonderilen dropdown elementin tum optionlari alinir
...
//      NOTE:SONRAKI DERSTE TEKRAR VE KULLANIMI
    ...
    public void selectFromDropdown(){
        selectFromDropdown(driver.findElement(By.xpath("//select[@id='year']")),"2005");//2005 sececek
